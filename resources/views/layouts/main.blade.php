            ...
            <div class="flex items-center">
                <div class="relative">
                    ...
                    <div class="absolute top-0">
                        <svg class="fill-current w-4 text-gray-500" viewBox="0 0 24 24"><path class="heroicon-ui" d="M16.32 14.9L5.39 5.4A1 1 0 01-1.42 1.4L-5.38A8 8 0 111.41-1.41ZM10 16A6 6 0 100-12 6 6 0 000 12Z" /></svg>
                    </div>
                </div>
            </div>
        </div>
